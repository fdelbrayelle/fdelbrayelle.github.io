...
description: "Staff Software Engineer. Lead Software Engineer at Kestra. 15+ years in Java, cloud-native architecture, and open-source. Grew Kestra plugin ecosystem from 600 to 1,700+ plugins (+183%, doubled in 9 months) in 13 months. 10,000+ GitHub contributions. GCP Professional Cloud Architect certified."
lang: en
permalink: /cv/
---
...
- [Kestra Fundamentals](https://academy.kestra.io/) — [Certificate](/Kestra%20Fundamentals-certificate.pdf) *(May 10, 2026)*
...
[kestra.io](https://kestra.io) — Open-source, agnostic, event-driven orchestrator for mission-critical workflows (AI, Data Engineering, Infrastructure). Squad of 3; close collaboration with Engineering, Product, Sales, Marketing/GTM, Customer Success, and Direction. 40+ enterprise customers, millions of workflows/month, [Kestra](https://github.com/kestra-io/kestra) ~30,000 GitHub stars.

**Team:** Plugins & Ecosystem Squad
...
- **Plugin Hub Growth:** Grew [plugin ecosystem from 600 to 1,700+](https://kestra.io/plugins) in 13 months (+183%, doubled in 9 months) across [200+ plugin repositories](https://github.com/orgs/kestra-io/repositories?q=plugin) (OSS & EE); [10,000+ GitHub contributions](https://github.com/search?q=author%3Afdelbrayelle+org%3Akestra-io&type=pullrequests) across the Kestra org; structured squad ownership, priorities, discovery and delivery
...
- **Developer Experience & Release Velocity:** Built [plugins-devtools](https://github.com/kestra-io/plugins-devtools) to automate dev, testing, and releases; introduced continuous automated releases and automated versioning across 1,700+ plugins; contributed to [plugin developer guide](https://kestra.io/docs/plugin-developer-guide); dogfooding Kestra for plugin automation ([LinkedIn post](https://www.linkedin.com/posts/fdelbrayelle_kestra-opensource-dataengineering-activity-7447888978512498688-bfBr), [blog post](https://kestra.io/blogs/2026-04-27-how-kestra-ships-plugins))
- **Architecture & Platform:** Designed Plugin Metadata & Releases API ([api.kestra.io](https://github.com/kestra-io/api.kestra.io)) & Versioned Plugin Docs architecture; drove performance improvements; shipped [NamespaceSync](https://github.com/kestra-io/plugin-git/pull/177) & [TenantSync](https://github.com/kestra-io/plugin-git/pull/180) for Git Sync (OSS & EE); covered EE features: [versioned plugins](https://kestra.io/docs/enterprise/instance/versioned-plugins), [secrets manager](https://kestra.io/docs/enterprise/governance/secrets-manager), [log shipper](https://kestra.io/docs/enterprise/governance/logshipper), [task runners](https://kestra.io/docs/task-runners), [storage](https://kestra.io/docs/concepts/storage); contributions to Kestra core — OSS: [Topology UI](https://github.com/kestra-io/kestra/pull/16795) (task runner YAML injection, remote components, modal slot), [CSRF token stabilization](https://github.com/kestra-io/kestra/pull/16894), [AI Copilot (Speech-to-Text)](https://github.com/kestra-io/kestra/pull/14174), [AI Copilot (MCP docs & blueprints)](https://github.com/kestra-io/kestra/pull/16104), [execution/trigger log purge](https://github.com/kestra-io/kestra/pull/14922); EE: [Plugin Release Notes modal](https://github.com/kestra-io/kestra-ee/pull/8085), [EE Registry PRIMARY-priority versioning](https://github.com/kestra-io/kestra-ee/pull/8463), [AdditionalPlugin subtypes (versioned IDs)](https://github.com/kestra-io/kestra-ee/pull/7927), [AI Copilot EE providers](https://github.com/kestra-io/kestra-ee/pull/7857), [searchInternalBlueprints source option](https://github.com/kestra-io/kestra-ee/pull/7139), [purge log options](https://github.com/kestra-io/kestra-ee/pull/6956)
- **New Plugins:** Created from scratch: [Mistral](https://github.com/kestra-io/plugin-mistral/pull/1), [Deepseek](https://github.com/kestra-io/plugin-deepseek/pull/2), [Beam](https://github.com/kestra-io/plugin-beam/pull/5), [Bluesky](https://github.com/kestra-io/plugin-bluesky/pull/3), [VMware EE](https://kestra.io/blogs/control-vmware-with-kestra), SAP EE, 1Password (private repos), [AI](https://github.com/kestra-io/plugin-ai) (AIAgent observability — [LinkedIn post](https://www.linkedin.com/feed/update/urn:li:share:7459842060225986560/)), and so much more
...
- **AI Enablement:** Led adoption of AI in engineering: led Content Engineering (skills & agents) on [Engineering AI Hub](https://github.com/kestra-io/engineering-ai-hub), co-authored AI Coding Agent Guidelines, and introduced remote MCP integrations for docs, plugins & blueprints ([blog post](https://kestra.io/blogs/2026-04-30-kestra-mcp-plugins-blueprints), [Kestra MCP: Live Documentation Access for AI Coding Agents](https://kestra.io/blogs/kestra-mcp-docs))
...
- **Evangelism:** Conferences: DevLille 2025 & [DevLille 2026](https://devlille.fr/talk-page-136143e9-347b-4884-b21c-ef9cd6caab40/) (talk: Kestra, plugins & AI agents), [Big Data London 2025](https://bigdataldn.com), [Data Days Lille 2026](https://fdelbrayelle.github.io/meetups/datadayslille2026/en/); Webinar: [Building and Maintaining Kestra's 1700+ Plugins](https://www.youtube.com/watch?v=FLwFfCUU5XI); DevRel: contributed to videos (Python/Go/JS SDK, Gemini/Ollama/OpenAI/Salesforce/VMware plugins), blog posts ([VMware](https://kestra.io/blogs/control-vmware-with-kestra), [infrastructure plugins](https://kestra.io/blogs/infra-automation), [MCP for plugins & blueprints](https://kestra.io/blogs/2026-04-30-kestra-mcp-plugins-blueprints), [Kestra MCP: Live Documentation Access for AI Coding Agents](https://kestra.io/blogs/kestra-mcp-docs), [how Kestra ships plugins](https://kestra.io/blogs/2026-04-27-how-kestra-ships-plugins)), LinkedIn posts
...
- Kestra plugins: [github.com/kestra-io](https://github.com/kestra-io) ([10,000+ contributions](https://github.com/search?q=author%3Afdelbrayelle+org%3Akestra-io&type=pullrequests))
